import {Card, EmptyState, IndexTable, Layout, Page, PageActions, Stack, TextStyle,} from '@shopify/polaris';
import {TitleBar, useAppBridge} from '@shopify/app-bridge-react';
import {useCreateSubscriptionMutation, useGetActiveSubscriptionsQuery,} from '@graphql/generated';
...
export default function Subscriptions() {
    ...
    const returnUrl = `${process.env.HOST}/subscriptions?host=${btoa(`${shop}/admin`)}`;
